...
void print_file_info(Fat12Entry *entry, FILE * in, char * parametro) {
    ...
    case 0xE5:
		...
		unsigned char b[] = {'B'};					//Charr que reemplazará el primer byte del archivo borrado
		unsigned int posicionInicial = ftell(in);			//guardo la posición en la que está parado al terminar de recorrer la entrada del archivo
